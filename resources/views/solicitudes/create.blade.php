                ...
                <div id="repuestos-container">
                    <div class="input-group mb-3 repuesto-group">
                        ...
                        <div class="input-group-append">
                            <button type="button" class="btn btn-success add-repuesto"><i class="fa fa-plus"></i></button>
                            <button type="button" class="btn btn-danger remove-repuesto"><i class="fa fa-trash"></i></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="trabajadores-container">
                    <div class="input-group mb-3 trabajador-group">
                        ...
                        <div class="input-group-append">
                            <button type="button" class="btn btn-success add-trabajador"><i class="fa fa-plus"></i></button>
                            <button type="button" class="btn btn-danger remove-trabajador"><i class="fa fa-trash"></i></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function setupAddRemoveButtons() {
            document.querySelectorAll('.add-repuesto').forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    const removeButton = newInputGroup.querySelector('.remove-repuesto');

                    // Limpiar el valor y resultados del nuevo input
                    newInputGroup.querySelector('.repuesto-search').value = '';
                    ...
                    // Mostrar botón de eliminar y añadir nuevo grupo
        ...
        function setupAddRemoveTrabajadorButtons() {
            document.querySelectorAll('.add-trabajador').forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    const newInputGroup = container.cloneNode(true);
                    const removeButton = newInputGroup.querySelector('.remove-trabajador');

                    // Limpiar el valor y resultados del nuevo input
                    newInputGroup.querySelector('.trabajador-search').value = '';
                    newInputGroup.querySelector('.results-container').innerHTML = '';
        ...
        // Inicializar búsqueda para el primer input group de repuestos
        setupRepuestoSearch(document.querySelector('.repuesto-group'));

        // Configurar botones para el primer input group de repuestos
        setupAddRemoveButtons();

        // Inicializar búsqueda para el primer input group de trabajadores
        setupTrabajadorSearch(document.querySelector('.trabajador-group'));

        // Configurar botones para el primer input group de trabajadores
